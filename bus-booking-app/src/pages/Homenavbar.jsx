...
import { faUser, faHome ,faEdit,faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
const Header = () => {
  ...
  <div className="navbar-right">
    ...
    {user && <Link to='/mybookings' className="mybookings-link">My Bookings</Link>}
  ...
  <div className="userDetails-popup">
    ...
    <li><span>{user.mobile}</span></li>
  </ul>
    </div>

    {/* ✅ Logout */}
    <div className="logout-container" onClick={handleLogout}>
      <FontAwesomeIcon icon={faSignOutAlt} className="popup-icon logout-icon" />
      <span>Logout</span>
    </div>
      ...
      {showModal && (
        <div className="editUser-modal">
          <div className="editUser-container">
            ...
            <Formik initialValues={{ name: user.name, email: user.email, mobile: user.mobile }}
              onSubmit={handleEditSubmit} validationSchema={validationSchema}>
              <Form>
                <div>
